    ...
    <div class="container">
      <div class="swiper-box">
        <div class="nav-menu">
          <ul class="menu-wrap">
            <li class="menu-item">
              <a href="javascrip:;">手机 电话卡</a>
              <div class="children">
                <ul v-for="(item,index) in menuList" :key="index">
                  <li v-for="(sub,i) in item" :key="i">
                    <a :href="sub?'/#/product/' + sub.id:''">
                      <img :src="sub? sub.img : '/imgs/item-box-1.png'" :alt="sub.id" />
                      {{sub ? sub.name : '小米9'}}
                    </a>
                  </li>
                </ul>
            ...
            <li class="menu-item">
              <a href="javascrip:;">电视 盒子</a>
            </li>
            <li class="menu-item">
              <a href="javascrip:;">家电 插线排</a>
            </li>
            <li class="menu-item">
        ...
        <swiper v-bind:options="swiperOption">
          <swiper-slide v-for="(item,index) in slideList" :key="index">
            <a v-bind:href="'/#/product/'+ item.id">
              <img v-bind:src="item.img" :alt="item.id" />
            </a>
          </swiper-slide>
